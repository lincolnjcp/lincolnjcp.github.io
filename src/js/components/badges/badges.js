            ...
            <div>
                ...
                <div class="row">
                    <div class="sm12 columns">
                        <h1 class="title title-XL mrg-L">Badges</h1>
                    ...
                    <div class="sm12 columns">
                        ...
                        <div class="row">
                            <div class="sm12 md6 columns">
                                <div class="algn-mid mrg-M"><img src="/images/design-system/badges/product-cards.jpg" alt="" /></div>
                                <h5 class="title title-M mrg-S">Product Cards</h5>
                            ...
                            <div class="sm12 md6 columns">
                                <div class="algn-mid mrg-M"><img src="/images/design-system/badges/product-page.jpg" alt="" /></div>
                                <h5 class="title title-M mrg-S">Product Page</h5>
                                <p class="max-width-text">Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec ullamcorper nulla non metus auctor fringilla. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row" id="appearance">
                    <div class="sm12 columns">
                        ...
                        <p class="mrg-XL max-width-text">Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
                        <div class="row">
                            ...
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-S">Single Line</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-S">Double Line</h5>
                                <p class="mrg-L max-width-text">Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec ullamcorper nulla non metus auctor fringilla. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor. </p>
                            </div>
                        </div>
                ...
                <div class="row" id="responsive-behavior">
                    <div class="sm12 columns">
                        <hr />
                        <h3 class="title title-L mrg-L">Examples</h3>
                        <p class="mrg-L">Min Width: 60px; 8px padding left and right; 85% Opacity on BG</p>
                        <div>
