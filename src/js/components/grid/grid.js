      ...
      <div>
        ...
        <div class="row" id="horizontal-grid">
          <div class="sm12 columns">
            ...
            <div class="row">
              <div class="sm12 columns">
                <p class="mrg-M algn-lft std-txt std-txt-S color-penneyred">full width</p>
              </div>
            </div>
            ...
            <h5 class="title title-M mrg-S">How The Grid Layout Works in Sketch</h5>
            ...
            <div class="mrg-M"><img src="/images/design-system/grids/grid-horizontal-grid-2.jpg" alt="" /></div>

            <h5 class="title title-M mrg-S">****How a Grid works in Code</h5>
            <p class="mrg-M">Within frameworks columns typically have gutters on either side of the column. This will not change the way pages are designed just good to understand how Sketch simplifies the grid.</p>
        ...
        <div class="row" id="documentation">
          <div class="sm12 columns">
            ...
            <p class="mrg-M">Material Designs Approach and Documentation of Units of Measurement<br />
