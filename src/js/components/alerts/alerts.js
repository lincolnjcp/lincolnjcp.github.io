            ...
            <div>
                <div class="row">
                    <div class="sm12 columns">
                        <h1 class="title title-XL mrg-btm-L">Alerts &amp; Messaging</h1>
                ...
                <div class="row" id="when-to-use">
                    <div class="sm12 columns">
                        ...
                        <p class=" mrg-btm-L max-width-text">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor don ullamco nulla non metus auctor fringilla. </p>
                        <div class="msg msg-success mrg-btm-M">Success! Item added to cart.<span class="icon msg-close color-success-type-svg " dangerouslySetInnerHTML={{ __html: closeImage }} /></div>
                        <div class="msg msg-error mrg-btm-XL">Please select a size.<span class="icon msg-close color-error-type-svg" dangerouslySetInnerHTML={{ __html: closeImage }} /></div>

                        <h4 class="title title-M mrg-btm-L">Best Practices</h4>
                    ...
                    <div class="sm12 columns">
                        ...
                        <div class="row">
                            <div class="sm12 md5 lg4 columns alert-preview-col">
                                <div class="msg msg-success mrg-btm-M">Success alert. <a href="javascript:void();">Text Link</a>
                                    <span class="icon msg-close color-success-type" dangerouslySetInnerHTML={{ __html: closeImage }} />
                                </div>
                                <div class="msg msg-success mrg-btm-M">Example to display a longer alert message with a full paragraph of content.</div>
                            </div>
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-btm-S">Success</h5>
                        ...
                        <div class="row">
                            <div class="sm12 md5 lg4 columns alert-preview-col">
                                <div class="msg msg-error mrg-btm-M">Error alert.</div>
                                <div class="msg msg-error mrg-btm-XL">Example to display a longer alert message with a full paragraph of content.</div>
                            </div>
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-btm-S">Error</h5>
                ...
                <div class="row" id="content-guidelines">
                    <div class="sm12 columns">
                        <hr />
                        <h3 class="title title-L mrg-btm-L">Content Guidelines</h3>
                        <p class="mrg-btm-L">Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>

                        <h4 class="title title-M mrg-btm-L">How to write effective alerts:</h4>
                        <ul class="list max-width-text color-slate">
                            <li>Aenean lacinia bibendum nulla sed consectetur</li>
                            <li>Integer posuere erat a ante venenatis dapibus posuere velit aliquet</li>
                            <li>Etiam porta sem malesuada magna mollis euismod. Lorem ipsum dolor sit amet, consec</li>
