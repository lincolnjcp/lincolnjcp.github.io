...
//color-jcp-red
  ...
  $(".color-jcp-red").click(function(){
    $(".design-system-toggle-section .icon").addClass("color-penneyred-svg");
  });
/*
    ...
    return (
      <div>
                ...
                <div className="row" id="alert">
                    ...
                    <div className="small-12 columns">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <a href="javascript:void();" class="color-default">Default Color</a> | 
                        <a href="javascript:void();" class="color-jcp-red">JCP Red</a>
                        <div className="row  small-up-4 medium-up-3 large-up-4 design-system-icon-set">
                          ...
                          {this.iconCol("thumbsup-fill", "like (active)", thumbsupfillImage)}
                          ...
                          {this.iconCol("heart-line", "save (inactive)", heartlineImage)}
                          ...
                          {this.iconCol("settings", "edit settings/preferences", settingsImage)}
                    ...
                    <div className="small-12 columns">
                      <h3>Utility</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <div className="row  small-up-4 medium-up-3 large-up-4 design-system-icon-set">
                          {this.iconCol("cart", "navigate to shopping cart", cartImage)}
