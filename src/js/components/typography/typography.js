            ...
            <div>
                <div class="row">
                    <div class="sm12 columns">
                        <h1 class="title title-XL mrg-btm-L">Typography</h1>
                        <h2 class="std-txt std-txt-XL mrg-btm-L max-width-text">Text is the primary way that users digest content and accomplish work, so it’s important to use good typographic principles to establish a clear visual hierarchy and to maximize legibility.<br /><br />
                ...
                <div class="row" id="price">
                    <div class="sm12 columns">
                        <h3 class="title title-L mrg-btm-L">Price <span class="design-system-css-class design-system-css-class-inline">class="price"</span></h3>
                ...
                <div class="row" id="title">
                    <div class="sm12 columns">
                        <h3 class="title title-L mrg-btm-L">Title <span class="design-system-css-class design-system-css-class-inline">class="title"</span></h3>
                        <p class="mrg-btm-L">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <div class="mrg-btm-L">
                ...
                <div class="row" id="standard-text">
                    <div class="sm12 columns">
                        <h3 class="title title-L mrg-btm-L">Standard Text <span class="design-system-css-class design-system-css-class-inline">class="std-txt"</span></h3>
                        <p class="mrg-btm-L">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <div class="mrg-btm-L">
                ...
                <div class="row" id="copy">
                    <div class="sm12 columns">
                        <h3 class="title title-L mrg-btm-L">Copy <span class="design-system-css-class design-system-css-class-inline">&lt;p&gt;</span></h3>
                        <p class="mrg-btm-L">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <div class="mrg-btm-L">
                ...
                <div class="row" id="links">
                    <div class="sm12 columns">
                        <h3 class="title title-L mrg-btm-L">Links</h3>
                        <p class="mrg-btm-L">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <p class="mrg-btm-L"><a href="javascript:void();">The quick brown fox jumps over the lazy dog.</a></p><br /><br /><br />
                        <p class="mrg-btm-L title-XSlink-S"><a href="javascript:void();">See Details</a></p>
                ...
                <div class="row" id="promo-labels">
                    <div class="sm12 columns">
                        <h3 class="title title-L mrg-btm-L">Promo Labels <span class="design-system-css-class design-system-css-class-inline">class=“promo-lbl”</span></h3>
                        <p class="mrg-btm-L">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <p class="promo-lbl promo-lbl-XXXL">Extra 20% Off</p>
                        <p class="design-system-css-class mrg-btm-XL">.promo-lbl-XXXL</p>
                        <p class="promo-lbl promo-lbl-XXL">Extra 20% Off</p>
                        <p class="design-system-css-class mrg-btm-XL">.promo-lbl-XXL</p>
                        <p class="promo-lbl promo-lbl-XL">Extra 20% Off</p>
                        <p class="design-system-css-class mrg-btm-XL">.promo-lbl-XL</p>
                        <p class="promo-lbl promo-lbl-L">Extra 20% Off</p>
                        <p class="design-system-css-class mrg-btm-XL">.promo-lbl-L</p>
                        <p class="promo-lbl promo-lbl-M">Extra 20% Off</p>
                        <p class="design-system-css-class mrg-btm-XL">.promo-lbl-M</p>
                        <p class="promo-lbl promo-lbl-S">+ get an extra 10% off with your JCPenney Credit Card</p>
                        <p class="design-system-css-class mrg-btm-XL">.promo-lbl-S</p>
                        <p class="promo-lbl promo-lbl-XS">+ get an extra 10% off with your JCPenney Credit Card</p>
                        <p class="design-system-css-class mrg-btm-XL">.promo-lbl-XS</p>
                    </div>
                </div>
                <div class="row">
                    <div class="sm12 columns">
