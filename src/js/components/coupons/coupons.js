        ...
        <div class="row flex-box">
          <div class="coupon-block flex-grid sm12 md6 lg4 xl3">
            <div class="coupon-list">
              ...
              <a href="javascript:void();" role="button" class="btn btn-S btn-primary btn-full mrg-S">Apply</a>
          ...
          <div class="coupon-block flex-grid sm12 md6 lg4 xl3">
            <div class="coupon-list">
              ...
              {/* <a href="javascript:void();" role="button" class="btn btn-S btn-secondary btn-full mrg-S btn-icon color-nightsky">
