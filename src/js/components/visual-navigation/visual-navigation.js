...
class VisualNavigation extends Component {
  ...
  render() {
    return (
      <div>
        <div class="row">
        <div class="viz-nav mrg-XXL">
            <h1 class="title-L mrg-XL title">Category Level - Circle</h1>
            <ul>
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  <div class="viz-nav-img mrg-S">
                    <img src="https://m.jcpenney.com/tablet/images/wmns-coats.jpg" alt="product-image" />
                  </div>
                  <h2 class="title title-M mrg-XS algn-mid">Tops</h2>
                </a>
              </li>
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  ...
                  <h2 class="title title-M mrg-XS algn-mid">Jeans</h2>
                </a>
              </li>
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  ...
                  <h2 class="title title-M mrg-XS algn-mid">Pants</h2>
                </a>
              </li>
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  ...
                  <h2 class="title title-M mrg-XS algn-mid">Dresses</h2>
                </a>
              </li>
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  ...
                  <h2 class="title title-M mrg-XS algn-mid">Cropped Pants</h2>
                </a>
              </li>
            </ul>
          </div>
          <div class="viz-nav mrg-XXL">
            <h1 class="title-L mrg-XL mrg-lft-XL">Subcategory Level - Circle</h1>
            <ul class="sub-category">
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  ...
                  <h2 class="title title-M mrg-XS algn-mid">Liz Claiborne</h2>
                  <p class="std-txt std-txt-M algn-mid">(627)</p>
                </a>
              </li>
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
          ...
          <div class="viz-nav viz-nav-squre mrg-XXL">
            <h1 class="title-L mrg-XL title">Category Level - Square</h1>
            <ul>
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  <div class="viz-nav-img mrg-S">
          ...
          <div class="viz-nav viz-nav-squre mrg-XXL">
            <h1 class="title-L mrg-XL mrg-lft-XL">Subcategory Level - Square</h1>
            <ul class="sub-category">
              <li class="mrg-XL mrg-lft-XL">
                <a href="#">
                  <div class="viz-nav-img mrg-S">
