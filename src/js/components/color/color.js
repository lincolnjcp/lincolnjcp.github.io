        ...
        return (
            ...
            <div class="row">
                <div class="sm12 columns">
                    <h1 class="title title-XL mrg-L">Color</h1>
                    <h2 class="std-txt std-txt-XL mrg-L max-width-text">JCPenney uses colors purposefully to communicate how things function in the interface. This helps us create visual patterns that can make interacting with our product easier and more predictable for customers.</h2>
                    <hr />
                    <div class="design-system-toggle-section">
                        <div class="row design-system-headline-with-toggle" id="core">
                            <div class="sm12 columns">
                                <h3 class="title title-L mrg-L">Core</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Red</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Grayscale</h4>
                    ...
                    <div class="design-system-toggle-section">
                        <div class="row design-system-headline-with-toggle" id="messaging">
                            <div class="sm12 columns">
                                <h3 class="title title-L mrg-L">Messaging</h3>
                                <div class="design-system-headline-toggle">
                                    <a href="javascript:void(0)" class="design-system-toggle left active">SCSS</a>
                                    <a href="javascript:void(0)" class="design-system-toggle right">Hex</a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Error</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Warning</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Success</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Neutral</h4>
                    ...
                    <div class="design-system-toggle-section">
                        <div class="row design-system-headline-with-toggle" id="rewards">
                            <div class="sm12 columns">
                                <h3 class="title title-L mrg-L">Rewards</h3>
                                <div class="design-system-headline-toggle">
                                    <a href="javascript:void(0)" class="design-system-toggle left active">SCSS</a>
                                    <a href="javascript:void(0)" class="design-system-toggle right">Hex</a>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Eggplant</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Platinum</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="sm12 md6 columns">
                                <h4 class="title title-M mrg-M">Gold</h4>
                    ...
                    <div class="design-system-toggle-section">
                        <div class="row design-system-headline-with-toggle" id="marketing">
                            <div class="sm12 columns">
                                <h3 class="title title-L mrg-L">Markerting</h3>
                                <div class="design-system-headline-toggle">
                                    <a href="javascript:void(0)" class="design-system-toggle left active">SCSS</a>
                                    <a href="javascript:void(0)" class="design-system-toggle right">Hex</a>
                                </div>
                        ...
                        <div class="row">
                            <div class="sm12 columns">
                                <p class="mrg-L max-width-text">The current brand pallete is reserved for brand and marketing assets. These color are not typically used in the UI. When using these color it is required to consult with the appropriate brand and/or marketing teams to ensure proper usage.</p>
                                <h5 class="title title-M mrg-S">Fall</h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="sm12 md6 columns">
                        ...
                        <div class="row">
                            <div class="sm12 columns">
                                <h5 class="title title-M mrg-S">Black Friday</h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="sm12 md6 columns">
                    ...
                    <div class="row" id="color-usage">
                        <div class="sm12 columns">
                            <h3 class="title title-L mrg-L">Color Usage</h3>
                    ...
                    <div class="row" id="accessibility">
                        <div class="sm12 columns">
                            <h3 class="title title-L mrg-L">Accessibility</h3>
