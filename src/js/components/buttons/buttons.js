            ...
            <div>
                <div class="row">
                    <div class="sm12 columns">
                        <h1 class="title title-XL mrg-btm-L">Buttons</h1>
                ...
                <div class="row" id="when-to-use">
                    <div class="sm12 columns">
                        ...
                        <p class="max-width-text mrg-btm-XL">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor don ullamco nulla non metus auctor fringilla. </p>
                        <div class="button-overview algn-mid-S mrg-btm-XL">
                            <a href="javascript:void();" role="button" class="btn btn-primary btn-L mrg-btm-L">Primary Large</a>
                            <a href="javascript:void();" role="button" class="btn btn-secondary btn-L mrg-btm-L">Secondary Large</a>
                            <a href="javascript:void();" role="button" class="btn btn-L btn-disabled mrg-btm-L">Disabled Large</a>

                        </div>
                        <h5 class="title title-M mrg-btm-M">Best Practices</h5>
                ...
                <div class="row" id="appearance">
                    <div class="sm12 columns">
                        ...
                        <p class="max-width-text mrg-btm-XXL">Cras mattis consectetur purus sit amet fermentum. Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Cras justo odio, dapibus ac facilisis in, egestas eget quam.</p>
                        <div class="row">
                            <div class="sm12 md5 lg4 columns mrg-btm-XL">
                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-primary btn-S mrg-btm-M">Primary Small</a>
                                </div>

                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-primary btn-M mrg-btm-M">Primary Medium</a>
                                </div>

                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-primary btn-L mrg-btm-M">Primary Large</a>
                                </div>
                            </div>
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-btm-M">Primary Action</h5>
                                <p class="mrg-btm-XXL">Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec ullamcorper nulla non metus auctor fringilla. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="sm12 md5 lg4 columns mrg-btm-XXL">
                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-secondary btn-S mrg-btm-M">Secondary Small</a>
                                </div>

                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-secondary btn-M mrg-btm-M">Secondary Medium</a>
                                </div>

                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-secondary btn-L mrg-btm-M">Secondary Large</a>
                                </div>
                            </div>
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-btm-M">Secondary Action</h5>
                                <p class="mrg-btm-XXL">Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec ullamcorper nulla non metus auctor fringilla. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="sm12 md5 lg4 columns">
                                <div class="button-preview algn-mid mrg-btm-XL">
                                    <a href="javascript:void();" role="button" class="btn btn-primary btn-L mrg-btm-M btn-icon "><span class="icon color-white-svg" dangerouslySetInnerHTML={{ __html: lockImage }} /> Checkout</a>
                                </div>
                                <div class="button-preview algn-mid mrg-btm-XL">
                                    <a href="javascript:void();" role="button" class="btn btn-secondary btn-L mrg-btm-M btn-icon"><span class="icon color-nightsky-svg lock-icon" dangerouslySetInnerHTML={{ __html: barcodeImage }} /> Print Barcode</a>
                                </div>

                            </div>
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-btm-M">Icon and Label</h5>
                                <p class="mrg-btm-XXL">Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec ullamcorper nulla non metus auctor fringilla. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="sm12 md5 lg4 columns mrg-btm-XXL">
                                ...
                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-secondary btn-L mrg-btm-M btn-icon btn-icon-slide"><span class="icon color-nightsky-svg" dangerouslySetInnerHTML={{ __html: cartImage }} /> <span class="btn-label">Add to Cart</span></a>
                                </div>

                                <div class="button-preview algn-mid">
                                    <a href="javascript:void();" role="button" class="btn btn-primary btn-L mrg-btm-M btn-icon btn-icon-slide"><span class="icon color-white-svg" dangerouslySetInnerHTML={{ __html: cartImage }} /> <span class="btn-label">Add to Cart</span></a>
                                </div>
                            </div>
                            <div class="sm12 md7 lg8 columns">
                                <h5 class="title title-M mrg-btm-M">Icon Hover Effect</h5>
                ...
                <div class="row" id="responsive-behavior">
                    <div class="sm12 columns">
                        <hr />
                        <h3 class="title title-L mrg-btm-L">Responsive Behavior</h3>
                        ...
                        <div class="design-system-container hide-for-small-only mrg-btm-L">
                            <p class="std-txt std-txt-S color-slate mrg-btm-L">CONTAINER</p>
                        ...
                        <div class="design-system-container design-system-container-small mrg-btm-L">
                            <p class="std-txt std-txt-S color-slate mrg-btm-L">CONTAINER</p>
                            <div class="design-system-container-inner algn-rght">
                                <a href="javascript:void();" role="button" class="btn btn-primary btn-L btn-full mrg-btm-M">Save</a>
                                <a href="javascript:void();" role="button" class="btn btn-secondary btn-L btn-full mrg-btm-M">Cancel</a>
                            </div>
                        </div>
                    </div>
                </div><br /><br /><br />
                ...
                <div class="md12 lg12 sm12 column mrg-btm-XL">
                    <h2 class="title title-L mrg-btm-M">Switch</h2>
                    <div class="switch-block md12 lg12 sm12">
                        <div class="md4 lg4 sm12 fl-left">
                            <div class="onoffswitch mrg-btm-XL fl-left">
                ...
                <div class="toggle-list sm12 md12 column row">
                    <h2 class="title-XL mrg-btm-L">Icon Toggle</h2>
                    <div class="icon-toggle mrg-rght-L mrg-btm-L">
                ...
                <div class="icon-group-block md12 lg12 sm12">
                    <h2 class="title-XL mrg-btm-L">Icon Group</h2>
                    <div class="icon-group product-gallery-block" role="group">
                        <div class="listIcon fl-left mrg-btm-XXL"></div>
                    </div>
                </div>

                <div class="md12 lg12 sm12 column mrg-btm-XL">
                    <h2 class="title title-L mrg-btm-M">Button Group</h2>
                    ...
                    <h2 class="title title-L mrg-btm-M">Disabled Button</h2>
                    <div><a href="#" role="button" class="btn btn-S btn-disabled mrg-btm-L">Disabled Button</a></div>
                    <div><a href="#" role="button" class="btn btn-M btn-disabled mrg-btm-L">Disabled Button</a></div>
                    <div><a href="#" role="button" class="btn btn-L btn-disabled mrg-btm-L">Disabled Button</a></div>
