...
class styleAWithoutButton extends Component {
	...
	render() {
		return (
			<div>
				...
				<div class="gallery js-flickity without-button">
					...
					<div class="gallery-cell">
						<div class="dynamic-banner color-white text-center">
							<h1 class="promo-lbl promo-lbl-XL color-white">50% Off Orders $40+</h1>
							<div class="proo-description">
								<span>with code</span>
								<span class="promo-code">SAVE27 </span>
								<span class="promo-end">Online & Instore. Ends 07/24. </span>
					...
					<div class="gallery-cell">
						<div class="dynamic-banner color-white text-center">
							<h1 class="promo-lbl promo-lbl-XL color-white">60% Off Orders $40+</h1>
							<div class="proo-description">
								<span>with code</span>
								<span class="promo-code">SAVE27 </span>
								<span class="promo-end">Online & Instore. Ends 07/24. </span>
